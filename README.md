...
* [Κεφ.5 Ονόματα, προσδέσεις και εμβέλειες](./cpl_sebesta/ch05/index.md)
  * [pl11ch5GR.pdf](./resources/pl11ch5GR.pdf)
...
[Λύσεις ασκήσεων εργαστηρίου 1](./resources/lab1_python_solutions.zip)
...
[Λύσεις ασκήσεων εργαστηρίου 2](./resources/lab2_python_solutions.zip)
...
[Λύσεις ασκήσεων εργαστηρίου 3](./resources/lab3_python_solutions.zip)
...
Ενισχύστε τις γνώσεις σας για τα παραπάνω:
* διαβάζοντας το κεφάλαιο 11 από το [Αγγελιδάκης-2015](http://aggelid.mysch.gr/pythonbook/).
* μελετώντας την παρουσίαση [Object-Oriented Programming](https://www.py4e.com/lectures3/Pythonlearn-14-Objects.pptx) από το [PY4E](https://www.py4e.com/)
...
* Συμπληρώστε, τον κώδικα στο [template4_4.py](./lab2022/week04/template4_4.py) έτσι ώστε η έξοδος να είναι η ακόλουθη. 
...
[Λύσεις ασκήσεων εργαστηρίου 4](./resources/lab4_python_solutions.zip)
...
Ενισχύστε τις γνώσεις σας για τα παραπάνω:
* διαβάζοντας για το tkinter το κεφάλαιο 12 από το [Αγγελιδάκης-2015](http://aggelid.mysch.gr/pythonbook/).
* ακολουθώντας τα [tutorials για το tkinter του pythontutorial](https://www.pythontutorial.net/tkinter/)
  * ιδιαίτερα το [Switching between Frames](https://www.pythontutorial.net/tkinter/tkraise/)
  * και το [Tkinter MVC](https://www.pythontutorial.net/tkinter/tkinter-mvc/)
  * και το [Tkinter Matplotlib](https://www.pythontutorial.net/tkinter/tkinter-matplotlib/)
...
[Λύσεις ασκήσεων εργαστηρίου 5](./resources/lab5_python_solutions.zip)
...
[Λύσεις ασκήσεων εργαστηρίου 6](./resources/lab6_haskell_solutions.zip)

---

### **Δεύτερο εργαστήριο Haskell**

* Από το [Haskell wikibook](https://en.m.wikibooks.org/wiki/Haskell) Elementary Haskell
  * Αναδρομή [2.1](./pl/haskell/wikibook/1_beginners_track/2_elementary_haskell/1_recursion.md)
  * Περισσότερα για τις λίστες, currying, η συνάρτηση ```map```, άπειρες λίστες [2.2.](./pl/haskell/wikibook/1_beginners_track/2_elementary_haskell/2_lists_ii.md)
  * Αποδοτική χρήση του ghci [2.9](./pl/haskell/wikibook/1_beginners_track/2_elementary_haskell/9_using_ghci_effectively.md)
...
<!-- 4. Ορίστε τη συνάρτηση ```length``` χρησιμοποιώντας μια βοηθητική συνάρτηση και μια συσσωρευτική παράμετρο. -->
...
[Λύσεις ασκήσεων εργαστηρίου 7](./resources/lab7_haskell_solutions.zip)

---

<!-- ### **Τρίτο εργαστήριο Haskell**

* Από το [Haskell wikibook](https://en.m.wikibooks.org/wiki/Haskell) Elementary Haskell
  * folds (```foldl```, ```foldr```, ```foldl1```, ```foldr1```), scans, filter, περιφραστικές λίστες [2.3](./pl/haskell/wikibook/1_beginners_track/2_elementary_haskell/3_lists_iii.md)
  * Δηλώσεις τύπων, data και type [2.4](./pl/haskell/wikibook/1_beginners_track/2_elementary_haskell/4_type_declarations.md)
...
[factorial.pl](./pl/prolog/factorial.pl)
...
**Άσκηση Ε9Α1**
Έστω ένας χάρτης με αριθμημένες περιοχές. Η πληροφορία για τις περιοχές του χάρτη που συνορεύουν δίνεται με μια λίστα της μορφής ```[[1,2],[1,3],[1,4],[1,5],[2,3],[2,4],[3,4],[4,5]]``` που σημαίνει ότι η περιοχή 1 συνορεύει με τις περιοχές 2, 3, 4, 5, κ.ο.κ. Κατασκευάστε το κατηγόρημα ```adjacent(X,Y,Map)``` με ορίσματα ```X``` και ```Y```, 2 αριθμούς περιοχών και ```Map``` τη λίστα με τις περιοχές που συνορεύουν. Το κατηγόρημα ```adjacent/3``` να επαληθεύεται όταν οι 2 περιοχές είναι γειτονικές. Επαληθεύστε με κατάλληλα ερωτήματα την ορθότητα του κατηγορήματος.

![](https://www.cpp.edu/~jrfisher/www/prolog_tutorial/f2_1_1.gif), ο χάρτης ```[[1,2],[1,3],[1,4],[1,5],[2,3],[2,4],[3,4],[4,5]]```
...
**Άσκηση Ε9Α2**
Το κατηγόρημα ```max\3``` πρέπει να επαληθεύεται όταν το τρίτο όρισμα είναι η μεγαλύτερη τιμή των 2 πρώτων ορισμάτων. Δίνεται η ακόλουθη υλοποίηση με χρήση cut. Μπορείτε να εντοπίσετε κάποιο παράδειγμα για το οποίο δεν λειτουργεί σωστά; Γιατί; Διορθώστε το.
...
**Άσκηση Ε9Α3**
Με τη χρήση της βιβλιοθήκης CLPFD, εντοπίστε όλες τις τιμές των ```X```, ```Y``` και ```Z``` με πεδία τιμών ακέραιους από το 1 μέχρι και το 20 για τις οποίες το άθροισμά τους είναι 15, η ```X``` είναι μεγαλύτερη από την ```Y``` και η ```Ζ``` είναι διπλάσια ή μεγαλύτερη της ```Y```.
