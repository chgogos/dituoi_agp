...
Δημιουργήστε το κατηγόρημα half_adder/4 που να υλοποιεί ένα κύκλωμα ημιαθροιστή. Δώστε 2 εναλλακτικές υλοποιήσεις με βάση τις ακόλουθες πληροφορίες.
...
Έστω το ακόλουθο γενεαλογικό δένδρο:
...
* ```siblings(X,Y)``` Ισχύει όταν ο ```Χ``` και ο ```Υ``` είναι αδέρφια.
...
**Άσκηση Ε8Α4**
Δίνεται ο ορισμός του κατηγορήματος ```factorial\2``` που υπολογίζει το παραγοντικό ενός ακεραίου αριθμού. 
