...
**Άσκηση E3A2** - Κατεβάστε σε txt μορφή το βιβλίο “Μεταμόρφωση” του Φ. Κάφκα από το https://www.gutenberg.org/ebooks/5200. Γράψτε πρόγραμμα που να διαβάζει το κείμενο. Στη συνέχεια, απομονώστε το κείμενο από τη γραμμή 17 μέχρι και τη γραμμή 24, μετατρέψτε το κείμενο σε πεζά γράμματα, και συμπληρώστε τις συναρτήσεις που απαντούν στα ακόλουθα ερωτήματα:
...
2. Ποιο είναι το πλήθος των διακριτών λέξεων του κειμένου που ξεκινούν με τον χαρακτήρα 'h' και τελειώνουν με τον χαρακτήρα 'e';
