...
Η έκφραση, π.χ. (sum + 47) / total, βρίσκεται σε αρχείο [front.in](./../../pl/c/lexer/front.in) και διαβάζεται από το εκτελέσιμο.
...
* [Λεκτικός αναλυτής](./../../pl/python/lexer_parser/index.md)
...
* Τερματικά σύμβολα: πεζά γράμματα στην αρχή του Αγγλικού αλφαβήτου (a, b, ...)
* Μη τερματικά σύμβολα: κεφαλαία γράμματα στην αρχή του Αγγλικού αλφαβήτου (A, B, ...)
* Τερματικά ή μη τερματικά: κεφαλαία γράμματα στο τέλος του Αγγλικού αλφαβήτου (W, X, Y, Z)
* Συμβολοσειρές τερματικών: πεζά γράμματα στο τέλος του Αγγλικού αλφαβήτου (w, x,y, z)
* Μεικτές συμβολοσειρές: πεζά γράμματα του Ελληνικού αλφαβήτου (α, β, γ, δ)
...
Η έκφραση, π.χ. (sum + 47) / total, βρίσκεται σε αρχείο [front.in](./../../pl/c/parser/front.in) και διαβάζεται από το εκτελέσιμο.
