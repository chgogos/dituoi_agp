...
Στις C, C++, Java, C# ο τύπος επιστροφής των συναρτήσεων δεν μπορεί να χρησιμοποιηθεί για τη διαφοροποίηση μεταξύ υπερφορτωμένων συναρτήσεων.

Για παράδειγμα οι ακόλουθοι ορισμοί συναρτήσεων θα οδηγήσουν σε αδυναμία μεταγλώττισης.
...
[overload_error.c](./../../pl/c/overload_error.c)
