...
* [google_stock_data.csv](./google_stock_data.csv)
* [cal_housing.csv](./cal_housing.csv) 
* [Διάφορα CSV αρχεία, συγκεντρωμένα από τον John Burkardt](https://people.sc.fsu.edu/~jburkardt/data/csv/csv.html)

## Excel

* [California housing (xlsx)](./cal_housing.xlsx)
* [California housing (xls)](./cal_housing.xls)

## XML

* [person.xml](./person.xml)
* [movies.xml](./movies.xml)
